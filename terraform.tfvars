...
gke_kubernetes_version        = "1.19." //  gcloud container get-server-config --zone australia-southeast1 <-- To find the available kube supoprted version for your region. Only specify major & minor version as shown here
...
aks_kubernetes_version      = "1.20.5" //Run to get right k8s version on aks for your region --> az aks get-versions --output table --location <your_location>
